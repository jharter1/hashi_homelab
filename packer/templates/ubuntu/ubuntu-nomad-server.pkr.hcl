...
source "proxmox-iso" "ubuntu-nomad-server" {
  # Proxmox Connection
  ...
  vm_id                = 9300
  vm_name              = "ubuntu-nomad-server"
  template_description = "Ubuntu 22.04 - Nomad Server with Consul"
...
build {
  sources = ["source.proxmox-iso.ubuntu-nomad-server"]
