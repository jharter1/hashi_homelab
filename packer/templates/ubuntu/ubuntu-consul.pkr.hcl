# Ubuntu template with HashiCorp Consul
# Builds on: ubuntu-qemu-agent (VM 9000)
# Adds: HashiCorp Consul binary installation
...
source "proxmox-iso" "ubuntu-consul" {
  # Proxmox Connection
  ...
  # VM Configuration
  vm_id                = 9002
  vm_name              = "ubuntu-consul"
  template_description = "Ubuntu 22.04 with QEMU Agent + Consul ${var.consul_version}"
  os                   = "l26"
...
build {
  sources = ["source.proxmox-iso.ubuntu-consul"]
